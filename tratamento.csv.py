...
arq = open("base.txt","r")
arq_results_csv = open("results.csv", "w", encoding='utf-8')
...
spamwriter.writerow(["Aluno = Saulo Henrique Gomes Castro"])
spamwriter.writerow(["Quantidade de Tweets avaliados = " + str(len(tweets)) + ""])

prepResultCSV("LINKS", links, spamwriter)
